...
const SinglePage = props => {
  ...
  return (
    <>
      <AppBanner />
      {props.comic
        ? setContent(process, ComicContent, single)
        : props.char
        ? setContent(process, CharContent, single)
        : null}
    </>
  );
};
...
const ComicContent = ({ data }) => {
  ...
  return (
    <div className="single">
      ...
      <Link to="/marvel-test-project/comics" className="single__back">
        Back to all
      </Link>
    </div>
  );
...
const CharContent = ({ data }) => {
  ...
  return (
    <div className="single">
      <Helmet>
        <meta name="description" content={`${name} single page`} />
        <title>{name}</title>
      </Helmet>
      <img src={thumbnail} alt={name} className="single__img" />
      <div className="single__info">
      ...
      <Link to="/marvel-test-project" className="single__back">
        Back main page
      </Link>
    </div>
  );
